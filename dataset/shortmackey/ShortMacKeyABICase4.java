...
public class ShortMacKeyABICase4 {
    private static final byte[] KEY_BYTES;
    private static byte[] keyBytes1;
    private static byte[] keyBytes2;

    static {
        KEY_BYTES = new byte[15];
        SecureRandom random2 = new SecureRandom();
        random2.nextBytes(KEY_BYTES);
    }
    ...
    private static void go3() throws NoSuchAlgorithmException, InvalidKeyException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, InvalidAlgorithmParameterException {
        ...
        SecretKeySpec keySpec = new SecretKeySpec(keyBytes2, "HmacSHA1");
