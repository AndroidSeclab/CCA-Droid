...
public class ShortMacKeyABICase5 {
    private static void go1(SecretKey key2, byte[] cipherBytes) throws NoSuchAlgorithmException, InvalidKeyException {
        go2(key2, cipherBytes);
    }

    private static void go2(SecretKey key2, byte[] cipherBytes) throws NoSuchAlgorithmException, InvalidKeyException {
