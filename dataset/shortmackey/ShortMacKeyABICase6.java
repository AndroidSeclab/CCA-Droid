...
public class ShortMacKeyABICase6 {
    private static void go1(SecretKeySpec keySpec, byte[] cipherBytes) throws NoSuchAlgorithmException, InvalidKeyException {
        go2(keySpec, cipherBytes);
    }

    private static void go2(SecretKeySpec keySpec, byte[] cipherBytes) throws NoSuchAlgorithmException, InvalidKeyException {
