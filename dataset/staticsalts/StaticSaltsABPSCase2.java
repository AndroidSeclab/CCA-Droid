...
public class StaticSaltsABPSCase2 {
    private static void go(int choice) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidAlgorithmParameterException, InvalidKeyException, InvalidKeySpecException, IllegalBlockSizeException, BadPaddingException {
        ...
        if (choice > 1) {
            ...
            random1.nextBytes(saltBytes1);
        } else {
            Arrays.fill(saltBytes1, (byte) 0xa2);
        }

        byte[] saltBytes2 = new byte[16];
        SecureRandom random2 = new SecureRandom();
        random2.nextBytes(saltBytes2);
